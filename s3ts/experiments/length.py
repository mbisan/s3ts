...
""" Experiment to check the effect of window length."""
...
def EXP_length(
    ...
    for i, length in enumerate(LENGTHS):
        ...
        crun += 1
        log.info(f"~ [{crun}/{trun}] Checking with window length {length}...")
        ...
        train_dm, pretrain_dm = prepare_dms(dataset=dataset,
            ...
            batch_size=batch_size, window_length=length, window_stride=window_stride, 
